  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-border bg-background hover:bg-accent hover:text-accent-foreground shadow-sm hover:shadow-md",
        ...
        hero: "bg-gradient-primary text-white hover:scale-105 shadow-xl hover:shadow-2xl border border-white/20",
        premium: "bg-gradient-surface border-2 border-primary/20 text-foreground hover:border-primary/40 shadow-lg hover:shadow-xl hover:-translate-y-0.5",
      },
      size: {
